export function PlayerName({ name, teamNumber, you = false, bot = false, nameWeight = 'bold' }: { name: string; teamNumber?: number; you?: boolean; bot?: boolean; nameWeight?: 'medium' | 'bold' }) {
