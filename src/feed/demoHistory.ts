  ...
  return {
    ...
    events: [
      ...
      },
      {
        ...
        receivedAt: new Date(startedAt.getTime() + 60_100).toISOString(),
        matchClockSeconds: 240,
        elapsedSeconds: 60.1,
        payload: {
          EventName: 'Save',
          Type: 'Save',
          MainTarget: { Name: 'You', Shortcut: 1, TeamNum: 0 },
        },
      },
      {
        id: `${id}:3`,
      ...
      },
      {
        ...
        sequence: 4,
        eventName: 'BallHit',
        receivedAt: new Date(startedAt.getTime() + 109_900).toISOString(),
        matchClockSeconds: 0,
        elapsedSeconds: 0,
        payload: {
          Players: [{ Name: 'You', Shortcut: 1, TeamNum: 0 }],
