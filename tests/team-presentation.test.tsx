...
const match: MatchState = {
  id: 'orange-win', lifecycle: 'completed', startedAt: '2026-08-08T00:00:00Z', lastEventAt: '2026-08-08T00:05:00Z', endedAt: '2026-08-08T00:05:00Z',
  playlistId: 11, playlistName: 'Ranked Doubles', playlistCategory: 'ranked', arena: 'DFH Stadium', timeSeconds: 0, isOvertime: false, isReplay: false,
  winnerTeamNumber: 1,
  teams: [{ teamNumber: 0, name: 'Blue', score: 0, colorPrimary: '' }, { teamNumber: 1, name: 'Orange', score: 2, colorPrimary: '' }],
  participants: [
    { name: 'Opponent', primaryId: 'Epic|opponent|0', teamNumber: 0, score: 50, goals: 0, assists: 0, saves: 0, shots: 1, touches: 4, demos: 0 },
    { name: 'You', primaryId: 'Steam|you|0', teamNumber: 1, score: 200, goals: 2, assists: 0, saves: 0, shots: 2, touches: 8, demos: 0 },
  ],
  events: [],
};
...
describe('user-first team presentation', () => {
  it('shows the user score first in game rows', () => {
    render(<MemoryRouter><MatchRow match={match} profileId="Steam|you|0" /></MemoryRouter>);
  ...
  it('shows the user team first in the scoreboard and summary score', () => {
    render(<MemoryRouter><MatchPage match={match} /></MemoryRouter>);
  ...
  it('shows the user score first in recent player meetings', () => {
    const history = calculatePlayerHistory([match], 'Steam|you|0', 'Epic|opponent|0');
